...
#### 安装配置
![](https://github.com/chaijunit/happyerqiao/blob/master/doc/image/start.png)
搭建好网站后，用浏览器访问，会出现配置界面


#### 在线写书

![](https://github.com/chaijunit/happyerqiao/blob/master/doc/image/book.png)
...
编辑器例子：[在线写书](https://www.happyerqiao.cn/bookeditor/book)

写好书籍后点击发布，就能在首页上看到最新书籍动态
![](https://github.com/chaijunit/happyerqiao/blob/master/doc/image/home.png)

#### 界面

beibq的界面简洁、美观、易用。阅读博客时，就像看书一样，界面包含书籍目录；这样只要点击目录的某个章节就能很方便切换到其他章节。

![](https://github.com/chaijunit/happyerqiao/blob/master/doc/image/reader.png)
